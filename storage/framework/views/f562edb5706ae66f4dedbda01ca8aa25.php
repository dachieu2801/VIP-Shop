...
<?php $__env->startSection('page-title-right'); ?>
  <a href="<?php echo e(admin_route('orders.shipping.get')); ?>?order_id=<?php echo e($order->id); ?>"target="_blank" class="btn btn-outline-secondary"><i class="bi bi-printer-fill"></i> <?php echo e(__('admin/order.btn_print')); ?></a>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
   <?php
                ...
                ?>
  <div class="card mb-4">
    <div class="card-header"><h6 class="card-title"><?php echo e(__('admin/common.order')); ?></h6></div>
  ...
  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('orders_update_status')): ?>
   <?php
                ...
                ?>
  <div class="card mb-4">
    <div class="card-header"><h6 class="card-title"><?php echo e(__('order.order_status')); ?></h6></div>
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <?php if(count($statuses)): ?>
          <el-form-item label="<?php echo e(__('order.change_to_status')); ?>" prop="status">
            <el-select class="wp-200" size="small" v-model="form.status" placeholder="<?php echo e(__('common.please_choose')); ?>">
              <el-option
          ...
          <el-form-item label="<?php echo e(__('order.express_company')); ?>" v-if="form.status == 'shipped'" prop="express_code">
            <el-select class="wp-200" size="small" v-model="form.express_code" placeholder="<?php echo e(__('common.please_choose')); ?>">
              <el-option
            ...
            <a href="<?php echo e(admin_route('settings.index')); ?>?tab=tab-express-company" target="_blank" class="ms-2"><?php echo e(__('common.to_setting')); ?></a>
          </el-form-item>
          <el-form-item label="<?php echo e(__('order.express_number')); ?>" v-if="form.status == 'shipped'" prop="express_number">
            <el-input class="w-max-500" v-model="form.express_number" size="small" v-if="form.status == 'shipped'" placeholder="<?php echo e(__('order.express_number')); ?>"></el-input>
          </el-form-item>
  ...
  <?php if($order->comment): ?>
    <div class="card mb-4">
      <div class="card-header"><h6 class="card-title"><?php echo e(__('order.order_comment')); ?></h6></div>
  ...
  <?php if($order->orderPayments): ?>
     <?php
                ...
                ?>
    <div class="card mb-4">
      <div class="card-header"><h6 class="card-title"><?php echo e(__('admin/order.payments_history')); ?></h6></div>
      <div class="card-body">
        <div class="table-push">
          <table class="table ">
            <thead class="">
            ...
            <tbody>
              ...
              <tr data-id="<?php echo e($ship->id); ?>">
                <td>
                  ...
                  <select class="form-select edit-form express-code d-none" aria-label="Default select example">
                    <?php $__currentLoopData = $expressCompanies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($item['code']); ?>" <?php echo e($ship->express_code == $item['code'] ? 'selected' : ''); ?>><?php echo e($item['name']); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                  <?php endif; ?>
                </td>
                <td>
                  ...
                  <input type="text" class="form-control edit-form express-number d-none" placeholder="<?php echo e(__('order.express_number')); ?>" value="<?php echo e($ship->express_number); ?>">
                </td>
                <td>
  ...
  <div class="card mb-4">
    <div class="card-header"><h6 class="card-title"><?php echo e(__('order.action_history')); ?></h6></div>
    <div class="card-body">
      <div class="table-push">
        <table class="table ">
          <thead class="">
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\workspace\shop-freelance\resources\/beike/admin/views/pages/orders/edit.blade.php ENDPATH**/ ?>