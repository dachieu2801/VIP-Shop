<div v-if="products.length">
  ...
  <div class="cart-mb-total">
    <div class="left">
      <label for="check-all">
        <input class="form-check-input" type="checkbox" value="" id="check-all" v-model="allSelected"> <?php echo e(__('shop/carts.selected')); ?>({{ total_quantity }})
      </label>
    </div>
    <div class="right">
      <span class="total-price fw-bold">{{ amount_format }}</span>
       <?php
                    ...
                    ob_start();
                ?>
      <button type="button" class="btn btn-primary btn-checkout fs-5 fw-bold" @click="checkedBtnToCheckout"><?php echo e(__('shop/carts.to_checkout')); ?></button>
       <?php
...
</div><?php /**PATH D:\shop-freelance\themes\default/cart/cart_mb.blade.php ENDPATH**/ ?>