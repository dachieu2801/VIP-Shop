        ...
        <div class="pb-images-selector" v-for="(item, index) in form.images" :key="index">
          ...
          <div :class="'pb-images-list ' + (item.show ? 'active' : '')">
            <div class="pb-images-top">
              ...
              <div class="tag"><?php echo e(__('admin/builder.text_suggested_size')); ?> 1000 x 500</div>
            </div>
...
<?php $__env->startPush('footer'); ?>
  <script>
    ...
    app.source.modules.push({
      title: '<?php echo e(__('admin/app_builder.module_slideshow')); ?>',
      code: 'slideshow',
      icon: '&#xe663;',
      content: {
        images: [
...
<?php $__env->stopPush(); ?>
<?php /**PATH G:\workspace\shop-freelance\resources\/beike/admin/views/pages/design/builder/app_component/slideshow.blade.php ENDPATH**/ ?>