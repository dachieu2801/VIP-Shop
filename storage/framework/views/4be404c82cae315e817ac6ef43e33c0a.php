...
<?php endif; ?>
  ...
  <img src="https://beikeshop.com/install/plugin.jpg?version=<?php echo e(config('beike.version')); ?>&build_date=<?php echo e(config('beike.build')); ?>&plugin=<?php echo e($plugin->code); ?>" class="d-none">
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\team-free-lance\shop-freelance\resources\/beike/admin/views/pages/plugins/form.blade.php ENDPATH**/ ?>