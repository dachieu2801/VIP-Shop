<template id="rich-text-i18n-template">
  <div class="rich-text-i18n-template">
    <el-button style="width: 100%;" icon="el-icon-edit-outline" plain @click="richTextDialogChecked('open')"><?php echo e(__('admin/builder.modules_edit_content')); ?></el-button>
    <el-dialog
      ...
      width="800px">
      <el-tabs v-if="languages.length > 1" value="language-<?php echo e(locale()); ?>" :stretch="languages.length > 5 ? true : false" type="card">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="richTextDialog.show = false"><?php echo e(__('common.cancel')); ?></el-button>
        <el-button type="primary" @click="richTextDialogSave"><?php echo e(__('common.confirm')); ?></el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
<?php /**PATH D:\team-free-lance\shop-freelance\resources\/beike/admin/views/pages/design/builder/component/rich_text_i18n.blade.php ENDPATH**/ ?>