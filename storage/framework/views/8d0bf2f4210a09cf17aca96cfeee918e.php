              ...
              <td>
                <div v-if="plugin.installed">
                  <div class="d-flex gap-2 flex-wrap">
                    ...
                    <a class="btn btn-outline-secondary btn-sm" target="_blank" :href="toBkTicketUrl(plugin.code)"><?php echo e(__('admin/plugin.ticket')); ?></a>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\team-free-lance\shop-freelance\resources\/beike/admin/views/pages/plugins/index.blade.php ENDPATH**/ ?>