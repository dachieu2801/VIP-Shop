              ...
              <tbody>
                ...
                ?>
                  <td class="text-end text-nowrap">
                      ...
                      <button  class="btn btn-outline-danger btn-sm" @click="deleteVoucher(<?php echo e($voucher['id']); ?>)"><?php echo e(__('common.delete')); ?></button>
                       <?php
                $__definedVars = (get_defined_vars()["__data"]);
                if (empty($__definedVars))
                {
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\shop-freelance\resources\/beike/admin/views/pages/vouchers/index.blade.php ENDPATH**/ ?>