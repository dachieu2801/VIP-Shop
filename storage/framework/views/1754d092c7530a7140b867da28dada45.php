<template id="module-editor-image402-template">
  <div class="image-edit-wrapper">
    ...
    <div class="module-edit-group">
      <div class="module-edit-title"><?php echo e(__('admin/builder.text_set_subtitle')); ?></div>
    ...
    <div class="module-edit-group">
      ...
      <div class="pb-images-selector" v-for="(item, index) in form.images" :key="index">
        ...
        <div :class="'pb-images-list ' + (item.show ? 'active' : '')">
          ...
          <div class="module-edit-title"><?php echo e(__('admin/builder.text_word')); ?></div>
...
<?php $__env->startPush('footer-script'); ?>
  <script>
    ...
    register.make = {
      ...
      floor: languagesFill(''),
      title: languagesFill('<?php echo e(__('admin/builder.text_set_title')); ?>'),
      sub_title: languagesFill('<?php echo e(__('admin/builder.text_set_subtitle')); ?>'),
      images: [
        {
          image: 'catalog/demo/banner/banner-402-1.jpg',
          show: true,
          title: languagesFill('<?php echo e(__('admin/builder.text_word')); ?>'),
          link: {
            type: 'product',
            value:''
          }
...
<?php $__env->stopPush(); ?>
<?php /**PATH G:\workspace\shop-freelance\resources\/beike/admin/views/pages/design/module/image402.blade.php ENDPATH**/ ?>