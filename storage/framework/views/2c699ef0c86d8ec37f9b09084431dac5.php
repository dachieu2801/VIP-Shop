...
<body>
    <div class="container">
        <div id="print-button">
            ...
            <p style="text-align: right;"><button class="btn btn-primary right" type="button" onclick="window.print()"
                    class="printer"><?php echo e(__("admin/order.btn_print")); ?></button></p>
        </div>
        ...
        <div style="page-break-after: always;">
            ...
            <table class="table">
                <tbody>
                    <tr>
                        <td>
                            <b><?php echo e(__("admin/order.shipping_customer_name")); ?>: </b>
                            <?php echo e($order['shipping_customer_name']); ?><br />
                            ...
                            <b><?php echo e(__("admin/order.shipping_address")); ?>: </b>
                            <?php echo e($order['shipping_address_1']); ?>,<?php echo e($order['shipping_zone']); ?>,
                            ...
                            <b>Địa chỉ cửa hàng: </b> <?php echo e($order['pick_up_address']); ?><br />
                            <b>Tên người nhận hàng: </b> <?php echo e($order['name']); ?><br />
                            <b>Số điện thoại: </b> <?php echo e($order['phone']); ?><br />
                            <?php endif; ?>
                            <b>Giờ nhận hàng: </b>
                            <?php echo e($order['receive_time'] ? $order['receive_time'] : $order['pick_up_time']); ?><br />
                        </td>
                        <td style="width: 50%;">
                ...
                <tbody>
                    <tr>
                        <td colspan="3">
                            ...
                            <b><?php echo e(__("admin/order.telephone")); ?>: </b> <?php echo e($order['shipping_telephone']); ?><br />
                            <b><?php echo e(__("admin/order.email")); ?>: </b> <?php echo e($order['email']); ?><br />
                            <b><?php echo e(__("admin/order.website")); ?>: </b> <a
                                href="<?php echo e($order['website']); ?>"><?php echo e($order['website']); ?></a>
                        </td>
                        </td>
                    </tr>
                </tbody>
...
</html><?php /**PATH D:\shop-freelance\resources\/beike/admin/views/pages/orders/shipping.blade.php ENDPATH**/ ?>