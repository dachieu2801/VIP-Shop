...
<?php $component = Beike\Shop\View\Components\Breadcrumb::resolve(['type' => 'brand','value' => $brand] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
