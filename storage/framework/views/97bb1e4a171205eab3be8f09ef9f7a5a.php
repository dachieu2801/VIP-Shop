<template id="text-i18n-template">
  <div class="text-i18n-template">
    <el-tabs v-if="languages.length > 1" value="language-<?php echo e(locale()); ?>"
...
<?php /**PATH D:\team-free-lance\shop-freelance\resources\/beike/admin/views/pages/design/builder/component/text_i18n.blade.php ENDPATH**/ ?>