    ...
    <div class="module-edit-group">
      ...
      <el-tabs v-model="form.editableTabsValue" class="tab-edit-category" type="card" editable @edit="handleTabsEdit">
        ...
        <div class="tab-info">
          ...
          <div class="module-edit-group">
            <div class="module-edit-title"><?php echo e(__('admin/builder.modules_product')); ?></div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH G:\workspace\shop-freelance\resources\/beike/admin/views/pages/design/module/tab_product.blade.php ENDPATH**/ ?>