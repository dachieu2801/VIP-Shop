...
<?php $__env->startSection('title', __('admin/builder.text_to_menu')); ?>
  ...
  <div class="card" id="app" v-cloak>
    <div class="card-body h-min-600 position-relative">
      <div class="design-wrap">
        <p class="fw-bold mb-2"><?php echo e(__('admin/builder.main_menu')); ?></p>
        <div class="left d-block d-lg-flex">
            ...
            <div
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center flex-grow-1">
                  <el-tooltip class="icon-rank cursor-scroll" effect="dark" content="<?php echo e(__('admin/builder.text_drag_sort')); ?>" placement="top">
                    <i class="el-icon-rank"></i>
                  </el-tooltip>
                  <div class="name mx-2">
                    <template v-if="menu.name[source.locale]">{{ menu.name[source.locale] }}</template>
                    <template v-else><?php echo e(__('admin/builder.please_add_data')); ?></template>
                  </div>
          ...
          <button @click="addLinkClicked" class="btn btn-outline-primary ms-lg-3"><?php echo e(__('admin/builder.add_main_menu')); ?></button>
        </div>
        <div class="flex-1 right" v-if="currentMenu" :key="currentMenuIndex">
          <div class="d-lg-flex">
            <div class="wp-200 ">
              <div class="mb-2"><?php echo e(__('admin/builder.main_menu_name_link')); ?></div>
            ...
            <div class="wp-200 ms-lg-5">
              <div class="mb-2 mt-3 mt-lg-0"><?php echo e(__('admin/builder.main_menu_label')); ?></div>
              <text-i18n v-model="currentMenu.badge.name" class=""></text-i18n>
            </div>

            <div class="wp-200 ms-lg-5">
              <div class="mb-2 mt-3 mt-lg-0"><?php echo e(__('admin/builder.label_background_color')); ?></div>
              <el-color-picker v-model="currentMenu.badge.bg_color" size="small"></el-color-picker>
            </div>

            <div class="wp-200">
              <div class="mb-2 mt-3 mt-lg-0"><?php echo e(__('admin/builder.label_text_color')); ?></div>
          ...
          <div class="children-group-wrap">
            <div class="d-flex align-items-center mb-3">
              <span class="fw-bold"><?php echo e(__('admin/builder.submenu_group')); ?></span>
              <div class="vr lh-1 mx-3 bg-secondary " style="height: 18px;"></div>
              <button class="btn btn-sm btn-link p-0" @click="addChildrenGroup"
                :disabled="currentMenu.childrenGroup.length >= 5"><?php echo e(__('admin/builder.add_menu_group')); ?></button>
              <div class="vr mx-3 lh-1 bg-secondary " style="height: 18px;"></div>
              <div>
                <span class="me-2"><?php echo e(__('admin/builder.full_screen')); ?></span>
              ...
              <div class="card border mx-2 mb-3 group-item" v-for="group, group_index in currentMenu.childrenGroup"
                ...
                <div class="card-header d-flex align-items-center justify-content-between mb-2">
                  <div class="" style="font-weight: 400">
                    <i class="el-icon-rank cursor-scroll"></i> <?php echo e(__('admin/builder.menu')); ?> - {{ group_index + 1 }}
                ...
                <div class="card-body p-2">
                  ...
                  <div class="group-children-info">
                    ...
                    <template v-else>
                      ...
                      <button @click="addChildrenLink(group_index)" class="btn btn-link btn-sm mt-2"><?php echo e(__('admin/builder.add_submenu_link')); ?></button>
                    </template>
                  </div>
                </div>
              </div>
    ...
    <el-dialog title="<?php echo e(__('admin/builder.text_set_up')); ?>" :visible.sync="childrenGroupPop.show" width="500px" v-if="currentMenu && currentMenu.childrenGroup.length">
      <p class="fw-bold mb-2"><?php echo e(__('admin/builder.type')); ?></p>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="childrenGroupPop.show = false"><?php echo e(__('common.cancel')); ?></el-button>
        <el-button type="primary" @click="childrenGroupPop.show = false"><?php echo e(__('common.confirm')); ?></el-button>
      </span>
    </el-dialog>
  </div>
<?php $__env->stopSection(); ?>
    ...
    let app = new Vue({
      ...
      data: {
        ...
        source: {
          ...
          types: [{
            name: '<?php echo e(__('admin/builder.modules_link')); ?>',
            value: 'link'
          },{
            name: '<?php echo e(__('admin/builder.text_image')); ?>',
            value: 'image'
          }],
        },
      },
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\team-free-lance\shop-freelance\resources\/beike/admin/views/pages/design/builder/menu.blade.php ENDPATH**/ ?>