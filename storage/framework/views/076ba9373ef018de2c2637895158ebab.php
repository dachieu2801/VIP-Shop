...
<?php $__env->startSection('page-bottom-btns'); ?>
  <button type="button" class="btn w-min-100 btn-lg btn-primary submit-form-edit"><?php echo e($type === "edit" ? __('common.save') : __('common.save_new')); ?></button>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\team-free-lance\shop-freelance\resources\/beike/admin/views/pages/vouchers/form.blade.php ENDPATH**/ ?>