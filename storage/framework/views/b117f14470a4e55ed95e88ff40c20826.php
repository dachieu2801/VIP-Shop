...
<head>
  ...
  <title><?php echo e(__('admin/builder.footer_edit')); ?></title>
    ...
    <div class="sidebar-edit-wrap" id="app" v-cloak>
      ...
      <div class="module-edit">
        <el-collapse value="intro" @change="footerItemChange" accordion>
          <el-collapse-item title="<?php echo e(__('admin/builder.text_service_icon')); ?>" name="services-wrap">
            <div class="module-edit-group">
              <div class="module-edit-group">
                <div class="module-edit-title"><?php echo e(__('admin/builder.text_enable')); ?></div>
              ...
              >
                <div class="pb-images-selector" v-for="(item, index) in form.services.items" :key="index">
                  ...
                  <div :class="'pb-images-list ' + (item.show ? 'active' : '')">
                    ...
                    <div class="tag"><?php echo e(__('admin/builder.text_suggested_size')); ?> 100 x 100</div>
                    <div class="module-edit-title"><?php echo e(__('admin/builder.text_title')); ?></div>
                    <text-i18n v-model="item.title"></text-i18n>
                    <div class="module-edit-title"><?php echo e(__('admin/builder.sub_title')); ?></div>
          ...
          <el-collapse-item title="Logo/<?php echo e(__('admin/builder.text_introduce')); ?>" name="footer-content-left">
            <div class="module-edit-group">
            ...
            <div class="module-edit-group">
              <div class="module-edit-title"><?php echo e(__('admin/builder.introduction')); ?></div>
              <rich-text-i18n v-model="form.content.intro.text"></rich-text-i18n>
            </div>
            <div class="module-edit-group" style="margin-bottom: 0">
              <div class="module-edit-title"><?php echo e(__('admin/builder.social_media_icons')); ?></div>
              ...
              >
                <div class="pb-images-selector" v-for="(item, index) in form.content.intro.social_network" :key="index">
                  ...
                  <div :class="'pb-images-list ' + (item.show ? 'active' : '')">
                    <pb-image-selector v-model="item.image" :is-language="false"></pb-image-selector>
                    <div class="tag"><?php echo e(__('admin/builder.text_suggested_size')); ?> 60 x 60</div>

                    <el-input placeholder="<?php echo e(__('admin/builder.text_enter_link')); ?>" size="small" v-model="item.link"></el-input>
                  </div>
                </div>
                <div>
                  <el-button class="add-item" size="mini" type="primary" plain @click="form.content.intro.social_network.push({image: '', link: '', show: true})"><?php echo e(__('admin/builder.text_add_link')); ?></el-button>
                </div>
              </draggable>
            </div>
          </el-collapse-item>
          <?php for($i = 1; $i <= 3; $i++): ?>
          <el-collapse-item title="<?php echo e(__('admin/builder.text_link_bar')); ?><?php echo e($i); ?>" name="footer-content-link<?php echo e($i); ?>">
            <div class="module-edit-group">
              <div class="module-edit-title"><?php echo e(__('admin/builder.text_set_title')); ?></div>
              <text-i18n v-model="form.content.link<?php echo e($i); ?>.title"></text-i18n>
            </div>
            <div class="module-edit-group">
              <div class="module-edit-title"><?php echo e(__('admin/builder.modules_link')); ?></div>

              <draggable
                ghost-class="dragabble-ghost"
                :list="form.content.link<?php echo e($i); ?>.links"
                :options="{animation: 330, handle: '.icon-rank'}">
                <div v-for="(item, index) in form.content.link<?php echo e($i); ?>.links" :key="index" class="footer-link-item">
                  <el-tooltip class="icon-rank" effect="dark" content="<?php echo e(__('admin/builder.text_drag_sort')); ?>" placement="left">
                    <i class="el-icon-rank"></i>
                  </el-tooltip>
                  <link-selector :is-custom-name="true" :hide-types="['product', 'category', 'brand']" v-model="form.content.link<?php echo e($i); ?>.links[index]"></link-selector>
                  <div class="remove-item" @click="removeLink('link<?php echo e($i); ?>', index)"><i class="iconfont">&#xe63a;</i></div>
                </div>
              </draggable>
            </div>
            <el-button class="add-item" size="mini" type="primary" plain @click="topLinkAddLinkButtonClicked(<?php echo e($i); ?>)"><?php echo e(__('admin/builder.text_add_link')); ?></el-button>
          </el-collapse-item>
          <?php endfor; ?>

          <el-collapse-item title="<?php echo e(__('admin/builder.text_static_information_contact')); ?>" name="footer-content-contact">
            <div class="module-edit-group">
              <div class="module-edit-title"><?php echo e(__('common.phone')); ?></div>
              <el-input placeholder="<?php echo e(__('common.phone')); ?>" size="small" v-model="form.content.contact.telephone"></el-input>
            </div>
            <div class="module-edit-group">
              <div class="module-edit-title"><?php echo e(__('admin/builder.text_address')); ?></div>
              
              <text-i18n type="textarea" v-model="form.content.contact.address"></text-i18n>
            </div>
            <div class="module-edit-group">
              <div class="module-edit-title"><?php echo e(__('admin/builder.text_email')); ?></div>
              <el-input placeholder="<?php echo e(__('admin/builder.text_email')); ?>" size="small" v-model="form.content.contact.email"></el-input>
            </div>
          </el-collapse-item>

          <el-collapse-item title="<?php echo e(__('admin/builder.text_copyright')); ?>" name="footer-bottom">
            <div class="module-edit-group">
              <div class="module-edit-title"><?php echo e(__('admin/builder.copyright_settings')); ?></div>
              <rich-text-i18n v-model="form.bottom.copyright"></rich-text-i18n>
            </div>
            <div class="module-edit-group">
              <div class="module-edit-title"><?php echo e(__('admin/builder.text_image')); ?></div>
...
<?php /**PATH D:\team-free-lance\shop-freelance\resources\/beike/admin/views/pages/design/builder/footer.blade.php ENDPATH**/ ?>