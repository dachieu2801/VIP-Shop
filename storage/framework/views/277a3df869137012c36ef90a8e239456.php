<div class="h-100 product-wrap <?php echo e(request('style_list') ?? ''); ?>">
  <?php if($product['origin_price'] > $product['price'] && $product['discount'] > 0): ?>
   ...
   <?php endif; ?>
    <button class="btn btn-link p-0 mt-1 text-secondary btn-wishlist-mobile" data-in-wishlist="<?php echo e($product['in_wishlist']); ?>" onclick="bk.addWishlist('<?php echo e($product['id']); ?>', this)">
