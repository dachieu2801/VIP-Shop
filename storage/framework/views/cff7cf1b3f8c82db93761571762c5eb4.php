  ...
  <link rel="stylesheet" href="<?php echo e(asset('plugin/stripe/css/demo.css')); ?>">
  <div class="mt-5" id="stripe-form" v-cloak>
    <hr class="mb-4">
    <div class="checkout-black">
      <h5 class="checkout-title"><?php echo e(__('Stripe::common.title_info')); ?></h5>
      <div class="">
        <div class="mb-4">
          <img src="<?php echo e(plugin_origin('stripe','/image/pay-image.png')); ?>" class="img-fluid">
        </div>
      ...
      <div>
        <button class="btn btn-primary btn-lg" type="button" @click="checkedBtnCheckoutConfirm"><?php echo e(__('Stripe::common.btn_submit')); ?></button>
      </div>
    </div>
  </div>
  <script>
    let cardNumberElement = null, cardExpiryElement = null, cardCvcElement = null, stripe = null, elements = null;
    const orderNumber = <?php echo json_encode($order->number ?? '', 15, 512) ?>;
    ...
    var stripeForm = new Vue({
      ...
      beforeMount() {
        stripe = Stripe("<?php echo e(plugin_setting('stripe.publishable_key')); ?>");
      },
