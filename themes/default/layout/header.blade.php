...
{{--            </a>--}}
      ...
      <div class="right nav">
        @if (system_setting('base.telephone', ''))
          ...
          <div class="my-auto" style="color: white"><i class="bi bi-telephone-forward me-2"></i> <b style="color: white">{{ system_setting('base.telephone') }}</b></div>
          @endhookwrapper
        @endif
...
{{--            </a>--}}
  ...
  <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvas-mobile-menu">
    <div class="offcanvas-header" style="background-color: #fb5631;">
      <h5 class="offcanvas-title" id="offcanvasWithBothOptionsLabel" style="color: white">{{ __('common.menu') }}</h5>
