    ...
    ->group(function () {
        ...
        Route::middleware('admin_auth:' . \Beike\Models\AdminUser::AUTH_GUARD)
            ->group(function () {
                ...
                Route::middleware('can:products_best_selling')->post('products/best-selling', [Controllers\ProductController::class, 'updateBestSelling'])->name('products.storeBestSelling');
