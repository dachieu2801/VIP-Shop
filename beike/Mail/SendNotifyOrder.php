...
class SendNotifyOrder extends Mailable
{
    ...
    {
        if ($this->details['type'] == 'notiUser') {
            $orderId      = $this->details['order']['number'];
            $customerName = $this->details['order']['customer_name'];
            $nameStatus   = $this->details['status'];
            $status = trans("common.$nameStatus");
            $comment      = $this->details['comment'];
            $url          = url('/account/orders/' . $this->details['order']['number']);
            ...
            <html lang='en'>
              <head>
                ...
                <title>Thông báo đơn hàng $orderId</title>
                <style>
                  body {
            ...
            background-color: #218838;
              ...
              <body>
                <div class='email-container'>
                  <div class='header'>
                    <h1>Thông báo đơn hàng $orderId</h1>
                  </div>
                  <div class='content'>
                    <p>Chào $customerName,</p>
                    <p>
                      Cảm ơn bạn đã mua sắm tại cửa hàng của chúng tôi. Đơn hàng của bạn $status
                    </p>
                    <p>
                      $comment
                    </p>
                    ...
                    <a href='$url' class='btn'>Xem Chi Tiết Đơn Hàng</a>
        ...
        if ($this->details['isShop']) {
            $url = url('/account/orders/' . $this->details['tracking_number']);
 ...
 <a href='$url' class='btn'>Xem Chi Tiết Đơn Hàng</a>
        ...
        $url = url('/admin/orders/' . $this->details['id']);
...
<body>
    <div class='email-container'>
        ...
        <div class='footer'>
            ...
            <p>&copy; Hệ thống quản lý đơn hàng của bạn</p>
            <p>Đơn hàng này được gửi từ hệ thống tự động. Vui lòng không trả lời email này.</p>
        </div>
    </div>
</body>
