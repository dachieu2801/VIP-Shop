...
use Beike\Shop\Http\Controllers\ProductReviewController;
    ...
    ->group(function () {
        ...
        Route::middleware('checkout_auth:' . Customer::AUTH_GUARD)
            ->group(function () {
                ...
                Route::post('product/review', [ProductReviewController::class, 'createProductReview'])->name('product.post_review');
                Route::get('product/reviews/{productId}/{orderProductId}', [ProductReviewController::class, 'index'])->name('product.get_review');
