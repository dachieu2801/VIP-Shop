...
class CartService
{
    ...
    public static function reloadData(array $carts = [], $customer = null): array
    {
        ...
        $origin_amount      = $cartList->sum('sub_total_origin_price');
        $data               = [
            'carts'                  => $carts,
            'quantity'               => $quantity,
            ...
            'origin_amount_format'   => currency_format($origin_amount),
            'discount_amount'        => $origin_amount - $amount,
            'discount_amount_format' => currency_format($origin_amount - $amount),
        ];
