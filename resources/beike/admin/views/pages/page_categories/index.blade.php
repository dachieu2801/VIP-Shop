          ...
          <tr>
            ...
            <td class="text-end">
              <a href="{{ admin_route('page_categories.edit',$item['id']) }}"
                class="text-nowrap mb-1 btn btn-outline-secondary btn-sm">{{ __('common.edit') }}</a>
              <button class="btn mb-1 btn-outline-danger btn-sm delete-btn" type='button' data-id="{{ $item['id'] }}">{{
