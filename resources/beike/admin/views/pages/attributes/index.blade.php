            ...
            <tr v-for="item, index in attributes.data" :key="index">
              ...
              <td>
                <div class="d-flex gap-2 flex-wrap">
                  <a class="text-nowrap btn btn-outline-secondary btn-sm" :href="linkEdit(item.id)">{{ __('common.edit') }}</a>
                  <button class="btn btn-outline-danger btn-sm" type="button" @click="deleteItem(item.id)">{{ __('common.delete') }}</button>
                </div>
              </td>
            </tr>
          </tbody>
