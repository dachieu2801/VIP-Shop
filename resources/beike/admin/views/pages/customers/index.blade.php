        ...
        <el-form :inline="false" :model="filter" class="demo-form-inline" label-width="auto">
          <div class="row">
            <div class="col-12 col-xl-6">
              <el-form-item class="w-100" label="{{ __('customer.name') }}">
                <el-input @keyup.enter.native="search" v-model="filter.name" size="small" placeholder="{{ __('customer.name') }}"></el-input>
              </el-form-item>
            </div>
            <div class="col-12 col-xl-6">
              <el-form-item class="w-100"  label="{{ __('customer.email') }}">
                <el-input @keyup.enter.native="search" v-model="filter.email" size="small" placeholder="{{ __('customer.email') }}"></el-input>
              </el-form-item>
            </div>
            <div class="col-12 col-xl-6">
              <el-form-item class="w-100"  label="{{ __('customer.customer_group') }}">
                <el-select class="w-100" size="small" v-model="filter.customer_group_id" placeholder="{{ __('common.please_choose') }}">
            ...
            <div class="col-12 col-xl-6">
              <el-form-item class="w-100"  label="{{ __('common.status') }}">
                <el-select class="w-100" size="small" v-model="filter.status" placeholder="{{ __('common.please_choose') }}">
          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr data-item='@json($customer)'>
                ...
                <td>
                  <select class="form-select customer-status form-select-sm" data-id="{{ $customer['id'] }}" style="min-width: 100px;max-width: 130px">
                ...
                <td>
                  @if ($type != 'trashed')
                   <div class="d-flex gap-2 flex-wrap">
                     <a class="text-nowrap btn btn-outline-secondary btn-sm" href="{{ admin_route('customers.edit', [$customer->id]) }}">{{ __('common.edit') }}</a>
