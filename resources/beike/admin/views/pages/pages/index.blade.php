      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-end">
              <a href="{{ admin_route('pages.edit', [$page['id']]) }}" class="mb-1 text-nowrap btn btn-outline-secondary btn-sm">{{
                __('common.edit') }}</a>
              <button class="btn btn-outline-danger btn-sm delete-btn mb-1" type='button' data-id="{{ $page['id'] }}">{{
